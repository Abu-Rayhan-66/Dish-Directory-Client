...
const AllFollower = ({params}:{params:{followerId:string}}) => {

    const {data, isLoading, error} = useUserWithPostedRecipeQuery(params?.followerId)
    ...
    return (
      ...
      { userData?.followers?.length ===0 ? (
         ...
         (
          userData.followers.map((item:TFollower )=>(
